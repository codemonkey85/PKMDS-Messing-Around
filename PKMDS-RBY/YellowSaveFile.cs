...
namespace PKMDS_RBY
{
    ...
    [Serializable]
    public class YellowSaveFile : ISaveFile
    {
        #region Constants
        ...
        public YellowSaveFile(Stream fileStream) => ReadFileStream(fileStream);

        public YellowSaveFile(string fileName)
        {
            FileStream fileStream = new FileStream(fileName, FileMode.Open, FileAccess.Read);
            ReadFileStream(fileStream);
        }

        public YellowSaveFile(byte[] fileData) => ReadFileBytes(fileData);
